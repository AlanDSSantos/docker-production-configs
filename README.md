...
├── rabbitmq/
│   └── docker-compose.yml      # Message broker com painel de gestão
├── verdaccio/
│   └── docker-compose.yml      # Registry privado npm
└── README.md
```

## 🚀 Como usar

Cada pasta contém um `docker-compose.yml` independente e pronto para uso.
...
| **Verdaccio** | Registry privado de pacotes npm | 4873 |

## 📋 Boas práticas aplicadas

- `restart: unless-stopped` — todos os containers sobem automaticamente após reboot
...
- [prometheus-grafana-stack](https://github.com/AlanDSSantos/prometheus-grafana-stack) — Stack completa de observabilidade
